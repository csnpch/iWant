...
//          Mock current choose location
            if (LocalStore(this).saveString("CurrentLocationLatLng", "${latLngChooseLocation[0]},${latLngChooseLocation[1]}")) {
                Toast.makeText(this, "current location is Saved", Toast.LENGTH_SHORT).show()
            } else {
                Toast.makeText(this, "current location is not saved :(", Toast.LENGTH_SHORT).show()
            }
